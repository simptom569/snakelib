...
const steps = [
  ...
  },
  {
    ...
    title: 'Оплатите',
    desc: 'Принимаем карты, наличные и перевод. Оплата возможна при получении для Москвы и МО.',
  },
  {
...
const payments = [
  {
    icon: '💳', dark: true,
    title: 'Онлайн картой',
    desc: 'Visa, Mastercard, МИР — оплата на сайте через защищённый шлюз. Данные карты не хранятся на наших серверах.',
    badge: 'Рекомендуем',
  },
  {
    icon: '📱', dark: false,
    title: 'СБП / перевод',
    desc: 'Быстрый перевод по номеру телефона через Систему быстрых платежей. Зачисление мгновенное.',
    badge: 'Без комиссии',
  },
  {
    icon: '💵', dark: false,
    title: 'Наличными',
    desc: 'Оплата наличными при получении доступна для курьерской доставки по Москве и МО.',
    badge: 'Только Москва и МО',
  },
  {
    icon: '🏦', dark: true,
    ...
    <PageWrapper>
      ...
      <Page>
        ...
        <PageHeader>
          ...
          <PageSubtitle>
            Доставляем живых питомцев по всей России — с контролем температуры и гарантией здоровья
          </PageSubtitle>
        </PageHeader>
