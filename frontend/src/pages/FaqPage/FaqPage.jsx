...
const FAQ = [
  {
    ...
    a: 'Для начинающих лучше всего подходят маисовые полозы и шаровые питоны — они спокойны, неприхотливы в уходе и редко кусаются. Напишите нам в чат или позвоните, и мы подберём питомца под ваши условия и опыт.',
  },
  {
    category: 'buy',
    q: 'Можно ли приехать и выбрать змею лично?',
    a: 'Да, мы принимаем гостей по предварительной записи. Вы сможете познакомиться с питомцем, задать все вопросы нашему специалисту и убедиться в его здоровье лично. Запись через телефон или форму обратной связи.',
  },
  {
    category: 'buy',
    q: 'Какие документы идут вместе со змеёй?',
    a: 'Каждая змея продаётся с ветеринарным свидетельством о здоровье. По запросу предоставляем документы о происхождении от заводчика и рекомендации по уходу и питанию в письменном виде.',
  },
  {
    category: 'buy',
  ...
  },
  {
    ...
    a: 'Доставляем по всей России. Москва и МО — курьером в день заказа. В другие города — через транспортные компании, работающие с живыми животными, обычно 1–3 дня.',
  },
  {
    category: 'delivery',
  ...
  },
  {
    ...
    a: 'Да, дату можно перенести не менее чем за 24 часа до запланированной доставки. Свяжитесь с нами по телефону или в мессенджере — всё решим быстро.',
  },
  {
    category: 'health',
  ...
  },
  {
    ...
    a: 'Да, каждая змея осматривается нашим ветеринаром перед продажей. Мы проверяем вес, состояние кожи, глаз, пасти и общую активность питомца. Результат осмотра фиксируется в ветеринарном свидетельстве.',
  },
];
