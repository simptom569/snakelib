    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.difficultylevel')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.snakecategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.IntegerField()),
                ('color', models.CharField(max_length=10)),
                ('snake', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.snake')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('snake', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.snake')),
            ],
        ),
        migrations.CreateModel(
            name='SnakeImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('morph', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.morph')),
                ('snake', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.snake')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.usercart')),
            ],
        ),
    ]
